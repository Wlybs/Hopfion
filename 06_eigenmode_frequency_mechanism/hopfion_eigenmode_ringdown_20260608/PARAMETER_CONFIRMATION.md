...
| 初始态 | `/mnt/d/Research/Hopfion/04_frustrated_fm_foundation/20260105_frustrated_fm/centered_stability_test/stability_Ku10k.out/m000020.ovf` | 同左 | Q_H=1，Ku=10k，与现有频扫同源 |
...
| Mumax3 文件 | `mx3/ringdown_sinc_Bx.mx3` | `mx3/ringdown_sinc_Bz.mx3` | 由共享库 `95_shared_scripts/resonance_analysis.py` 生成 |
