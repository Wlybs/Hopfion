...
规范来源：09_paper_thesis_talks/bishe/thesis_v2/figures/fig3-* 系列的视觉风格 +
...
THESIS_FONTS_DIR = Path("/mnt/d/Research/Hopfion/09_paper_thesis_talks/bishe/thesis_v2/fonts")
...
def setup_paper_style() -> None:
    ...
    mpl.rcParams.update({
        ...
        # 强制白底（覆盖任何 seaborn/全局 style 残留的灰底，论文规范）
