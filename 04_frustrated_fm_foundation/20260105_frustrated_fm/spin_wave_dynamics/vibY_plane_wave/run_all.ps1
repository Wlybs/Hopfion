# vibY Plane Wave — Run all 36 simulations sequentially
...
$mx3Files = Get-ChildItem -Filter "sw_*.mx3" | Sort-Object Name
$total = $mx3Files.Count
$i = 0

Write-Host "=== vibY Plane Wave: $total simulations ===" -ForegroundColor Cyan
$startTime = Get-Date
