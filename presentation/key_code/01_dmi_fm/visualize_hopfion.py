...
plt.colorbar(im1, ax=axes[0], fraction=0.046, pad=0.04, label='mz')
# 圆盘边界
...
plt.colorbar(im2, ax=axes[1], fraction=0.046, pad=0.04, label='mz')
...
plt.colorbar(im3, ax=axes[2], fraction=0.046, pad=0.04, label='mz')
