...
\RequirePackage
  [ skip = 1.75ex, labelsep = quad ]{caption}
\DeclareCaptionFont{wuhao}{\linespread{1}\fontsize{10.5pt}{20pt}\selectfont}
...
\renewcommand*\theequation {\arabic{chapter}\text{-}\arabic{equation}}
    ...
    \setbox0 = \vbox
      {
        ...
        \unless\ifvoid2
          ...
          \int_compare:nNnTF { \l_tmpa_int } = { 1 }
            {
              \global\setbox1 = \vtop
                { \hbox to\hsize{\hfil\strut\unhbox2\hfil}
