...
数据源:
  OVFs: /mnt/d/Research/Hopfion/04_frustrated_fm_foundation/20260105_frustrated_fm/drift_experiments/
        bg_mx_axis_x_stable/run.out/m*.ovf
  缓存 CSV: figures/drift10ns_centroid_bg_mx_axis_x.csv (首次运行自动生成)

输出:     /mnt/d/Research/Hopfion/09_paper_thesis_talks/bishe/thesis_v2/figures/fig3-4_drift_trajectory_10ns.png
...
CACHE_CSV = '/mnt/d/Research/Hopfion/09_paper_thesis_talks/bishe/thesis_v2/figures/drift10ns_centroid_bg_mx_axis_x.csv'
